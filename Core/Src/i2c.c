...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(barometre_scl_GPIO_Port, barometre_scl_Pin);

    HAL_GPIO_DeInit(barometre_sda_GPIO_Port, barometre_sda_Pin);
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PA8     ------> I2C3_SCL
    */
    HAL_GPIO_DeInit(imu_sda_i2c3_GPIO_Port, imu_sda_i2c3_Pin);

    HAL_GPIO_DeInit(imu_scl_i2c3_GPIO_Port, imu_scl_i2c3_Pin);
