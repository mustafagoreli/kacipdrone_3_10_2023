...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PA6     ------> TIM3_CH1
    */
    HAL_GPIO_DeInit(pwm_input_3_GPIO_Port, pwm_input_3_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD12     ------> TIM4_CH1
    */
    HAL_GPIO_DeInit(pwm_input_4_GPIO_Port, pwm_input_4_Pin);
  ...
  /* USER CODE END TIM12_MspDeInit 0 */
    ...
    PB14     ------> TIM12_CH1
    */
    HAL_GPIO_DeInit(pwm_input_5_GPIO_Port, pwm_input_5_Pin);
